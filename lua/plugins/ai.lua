...
return {
  ...
  if not require("sidekick").nes_jump_or_apply() then
    return "<Tab>" -- fallback to normal tab
      ...
      {
        "<leader>av",
        function()   require("sidekick.cli").send({ msg = "{selection}" })
end,
        mode = { "x" },
      ...
      {
        "<leader>ap",
        function()   require("sidekick.cli").prompt()
end,
        mode = { "n", "x" },
      ...
      {
        "<c-.>",
        function()   require("sidekick.cli").focus()
end,
        mode = { "n", "x", "i", "t" },
      ...
      {
        "<leader>ac",
        function()   require("sidekick.cli").toggle({ name = "claude", focus = true })
end,
